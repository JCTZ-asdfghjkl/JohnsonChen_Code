...
def set_config():
    ...
    parser.add_argument('--label-type', type=str, default='Delta', choices=['Delta', 'Theta', 'Alpha', 'Beta'])
    ...
    parser.add_argument('--model', type=str, default='AT-DGNN',
                        choices=['AT-DGNN', 'LGGNet', 'EEGNet', 'EEGNetRegressor', 'DeepConvNet', 'ShallowConvNet', 'EEG-TCNet',
